  ...
  const TEAM_COMP_2 = [
    {
      ...
      difficulty: 5,
      description: "",
      strengths: "This team has high damage output and superior defensive capabilities to prevent the enemy team from pushing forward even with shields from Doctor Strange or Magneto. They can also easily destroy divers like Hulk and Venom.",
      weaknesses: "Skilled flankers that use Black Panther, Psylocke, or Magik can potentially destroy your backline and pave the way for their team to push forward.",
      image: "https://res.cloudinary.com/dqrtlfjc0/image/upload/v1737634370/rivals%20v2/gunner-lineup_zxteew.png",
      lineups: [
        {
          tanks: ["https://res.cloudinary.com/dqrtlfjc0/image/upload/v1736484730/Rivals/Peni_Parker_Icon_u0uafv.webp", "https://res.cloudinary.com/dqrtlfjc0/image/upload/v1736484729/Rivals/Groot_Icon_udutn9.webp"],
          duels: ["https://res.cloudinary.com/dqrtlfjc0/image/upload/v1736484733/Rivals/The_Punisher_Icon_hqyd44.webp", "https://res.cloudinary.com/dqrtlfjc0/image/upload/v1736484733/Rivals/Winter_Soldier_Icon_lceqsq.webp"],
    ...
    },
    {
      ...
      weaknesses: "This team composition has few weaknesses, but it's vulnerable if your strategists' ultimates are on cooldown and enemy flankers destroy your backline. This can create opportunities for the enemy team to eliminate Hulk and the rest of your team.",
      image: "https://res.cloudinary.com/dqrtlfjc0/image/upload/v1737638975/rivals%20v2/meta_1_m3erci.png",
      lineups: [
        {
          tanks: ["https://res.cloudinary.com/dqrtlfjc0/image/upload/v1736484729/Rivals/Hulk_Icon_d2xnfs.webp", "https://res.cloudinary.com/dqrtlfjc0/image/upload/v1736484729/Rivals/Doctor_Strange_Icon_qtd9ik.webp"],
          duels: ["https://res.cloudinary.com/dqrtlfjc0/image/upload/v1736484734/Rivals/Wolverine_Icon_xhlm8q.webp", "https://res.cloudinary.com/dqrtlfjc0/image/upload/v1736484729/Rivals/Iron_Man_Icon_vyqsna.webp"],
    ...
    },
    {
      ...
      difficulty: 5,
      description: "",
      strengths: "This team composition relies on fast-paced gameplay and accurate killing abilities that eliminate targets one by one. They are most effective against airborne enemies like Iron Man and Storm.",
      weaknesses: "They will have issues dealing with a team comp that can easily escape with their high mobility and high healing abilities.",
        ...
        <div className="w-full px-3 md:px-0 md:w-[1200px] mx-auto pb-[150px] pt-[40px]">
          ...
          <div className="flex flex-col md:flex-wrap mt-[60px]">
            {TEAM_COMP_2.map((team: any, index: any) => (
              <div
                key={index}
                className="w-full md:w-full border-t border-neutral-700 rounded-lg pt-6 px-6 cursor-pointer overflow-hidden relative"
              >
                <Image 
                  className="absolute z-1 right-0 mt-[120px] opacity-[12%]"
                  src={team.image} alt="Gunner lineup image" width={700} height={300} 
                />
                <h4 className="text-3xl md:text-4xl text-white font-black uppercase">{team.name}</h4>
                <p className="mt-2 text-[#A0A0AF] relative z-2">{team.description}</p>
                <div className="mt-4">
                  <h4 className="text-md text-white font-bold">Best used for:</h4>
                ...
                <div className="flex flex-col md:flex-row gap-5 pb-[50px]">
                  <div className="flex-1">
                    {team.lineups.map((lineup: any, lineupIdx: number) => (
                      <div key={lineupIdx}>
                        <h4 className="text-md mt-7 mb-4 text-white font-bold">Heroes:</h4>
                        ...
                        <div className="flex gap-5 mt-3 items-center">
                          ...
                          <div className="flex gap-2">
                            {lineup.duels.map((duel: any, duelIdx: number) => (
                              <div key={duelIdx}>
                                <Image src={duel} alt={duel} width={70} height={70} className="rounded-md" />
                              </div>
                            ))}
                          </div>
                        </div>
                        <div className="flex gap-5 mt-3 items-center">
                          ...
                          <div className="flex gap-2">
                            {lineup.strats.map((strat: any, stratIdx: number) => (
                              <div key={stratIdx}>
                                <Image src={strat} alt={strat} width={70} height={70} className="rounded-md" />
                              </div>
                            ))}
                          </div>
                        </div>
                  ...
                  <div className="mt-7 flex-1">
                    <h4 className="text-md text-white font-bold">Weaknesses:</h4>
