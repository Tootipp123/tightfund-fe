          ...
          <section className="md:px-[100px] bg-white py-[60px] rounded-xl m-auto">
            <div className="w-full md:w-[400px]">
              <h3 className="text-dark-main md:mt-4 text-2xl font-semibold text-center">
                Your emergency fund target is ready!
              </h3>
              <p className="text-dark-main md:mt-4 text-2xl font-semibold text-center">
                Create an account for free to see it. This also allows you to
                save your results, track your progress, and get tailored
                insights over time.
              </p>
              <div className="my-7">
                <button
