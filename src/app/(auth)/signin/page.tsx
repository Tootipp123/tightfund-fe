            ...
            <div className="w-[90%] h-[550px] md:w-[500px] md:h-[700px] border border-neutral-800 bg-dark-bg p-7 overflow-auto m-auto">
              ...
              <section className="mt-10">
                ...
                <p className="text-neutral-200 text-md font-light mt-3">
                  We respect your privacy, and we are committed to protecting
                  any personal information you provide to us. We do not store or
                ...
                <p className="dark:text-neutral-200 text-md font-light mt-3">
                  Any data you share with us for the purpose of using our
                  services will only be used for the intended purpose and will
                  not be stored beyond what is necessary.
                </p>
              </section>
              ...
              <section className="mt-7">
                ...
                <p className="dark:text-neutral-200 text-md font-light mt-3">
                  We will update this Privacy Policy occasionally and as
                  required by legal, regulatory or operational modifications. We
                  will notify such changes (including the effective date) as
                  required by law.
                </p>
              </section>
            </div>
