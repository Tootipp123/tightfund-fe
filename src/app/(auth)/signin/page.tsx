    ...
    <>
      ...
      {showTermsAndConditionsModal && (
        <Modal onClose={() => setShowTermsAndConditionsModal(false)}>
          <div className="w-[90%] h-[550px] md:w-[500px] md:h-[700px] bg-light-main p-7 overflow-auto m-auto">
            <h1 className="text-dark-main text-xl font-bold">PRIVACY POLICY</h1>
            <section className="mt-10">
              <h2 className="text-dark-main font-semibold text-xl">
                User Data Privacy
              </h2>
              <p className="text-dark-main text-md font-light mt-3">
              ...
              <p className="dark:text-dark-main text-md font-light mt-3">
            ...
            <section className="mt-7">
              <h2 className="dark:text-dark-main font-semibold text-xl">
                Security
              </h2>
              <p className="dark:text-dark-main text-md font-light mt-3">
